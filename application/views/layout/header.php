  ...
  <header id="header">
    ...
    <div class="container">
      ...
      <div class="logo float-left">
        <a href="#intro" class="scrollto"><img src="<?php echo $assets; ?>logo_blanco.png" alt="Logo Campestre"  width="160px"  /></a>
      </div>

      <nav class="main-nav float-right d-none d-lg-block">
        <ul>
          <li class="active"><a href="#intro">Inicio</a></li>
          <li><a class="e" href="#casas">Prototipos</a></li>
          <li><a class="e" href="#mapa">Mapa</a></li>
          <li><a class="e" href="#blog">Blog</a></li>
          <li><a class="e" href="#msj">Contacto</a></li>
        </ul>
      </nav><!-- .main-nav -->
