...
<!--==========================
  ...
  <section id="intro" class="clearfix">
    <div class="container d-flex h-100 encima ">
      <div class="row justify-content-center align-self-center">
        <div class="col-sm-9 intro-info " style="margin-left: 200px;">
          <h2>CONOCE <span>AMBAR</span></h2>
          <div>
            <a href="#img" data="Ambar" id="btn-info" class="btn-get-started scrollto">Solicita Información.</a>
          </div>
        </div>
    ...
    <img class="bannerimg" src="<?php echo $sitio; ?>prototipos/ambar.jpg"  width="100%" height="100%" />
  </section>
